...
const downloads = [
  ...
  {
    thumbnail: thum3,
    title: "Biggest Lie | How to Know if it's Fake or Lie | Shushant Upadhyay and Fall of Mughal Empire | Animated India ",
    channel: "YourSelf ",
    views: "17M views",
    days: "1 day ago",
    length: "1:58",
          ...
          <div className="yt-downloads-mainn">
            <div className="yt-d-header-flex">
              <h2 className="yt-d-h2">
                DOWNLOADS{" "}
                <span className="yt-d-count">({downloads.length})</span>
              </h2>
              <button
