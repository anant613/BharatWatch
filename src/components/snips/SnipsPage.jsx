...
import carImg from "./images/profile1.png";
  ...
  return (
    <div className="reel-ui-row">
      ...
      <div className="reel-right-stack">
        <div className="ad-box-ui">AD</div>
              ...
              {isLikedArr[reelIndex] ? (
                ...
                >
                  <g filter="url(#filter0_d_378_1360)">
                    ...
                    />
                    <path
                      d="M51.6609 44.1792C52.226 44.1795 52.6841 44.6375 52.6843 45.2026V50.5991C52.6843 51.1644 52.2261 51.6232 51.6609 51.6235H23.6414C23.076 51.6234 22.6179 51.1645 22.6179 50.5991V45.2026C22.6181 44.6374 23.0761 44.1794 23.6414 44.1792H51.6609ZM24.4792 49.7612H50.823V46.0405H24.4792V49.7612ZM35.6257 14.6743C36.2536 14.5796 36.8576 14.9738 37.0242 15.5864L37.0525 15.7212L38.7615 26.5474L39.8806 28.3198L41.7751 27.5698V20.0815C41.7755 19.388 42.3384 18.8249 43.032 18.8247H48.1335C48.8273 18.8247 49.39 19.3878 49.3904 20.0815V33.9253C49.3904 34.0925 49.3565 34.2584 49.2917 34.4126L45.7976 42.7124C45.6014 43.1784 45.145 43.481 44.6394 43.481H30.6609C30.1555 43.4808 29.6989 43.1782 29.5027 42.7124L26.0242 34.4517C25.8311 33.9924 25.9276 33.4618 26.2703 33.1001L31.1218 27.9771L29.4626 17.4614C29.3625 16.8249 29.7605 16.2148 30.3835 16.0503L35.491 14.7026L35.6257 14.6743ZM31.9119 18.0532L33.4392 27.731L36.5173 30.1675C37.1528 30.6705 37.1526 31.635 36.5173 32.1382L33.239 34.7329L31.6375 37.269C31.2613 37.8646 30.4774 38.028 29.8982 37.6558L31.3708 41.1538H43.9294L45.6248 37.1255L40.9187 36.7466C40.4891 36.7118 40.1062 36.4594 39.906 36.0776L38.4539 33.3062C38.0719 32.5769 38.4818 31.6835 39.2839 31.4985L47.0632 29.7065V21.1519H44.1023V28.2983C44.1023 28.8138 43.7867 29.2775 43.3074 29.4673L39.9128 30.811C39.3511 31.0333 38.7101 30.8238 38.3875 30.313L36.6765 27.604C36.5855 27.4596 36.5244 27.297 36.4978 27.1284L34.9382 17.2544L31.9119 18.0532ZM28.4558 34.1763H28.8035C29.0509 34.1763 29.2928 34.2495 29.4978 34.3853L29.5837 34.4478L30.3054 35.019L30.9851 33.9438L30.0613 32.481L28.4558 34.1763ZM41.157 33.4536L41.6921 34.4741L46.575 34.8677L47.0632 33.7095V32.0942L41.157 33.4536ZM31.7126 30.7378L32.6541 32.228L34.0125 31.1528L32.4734 29.9341L31.7126 30.7378Z"
                      fill="#363535"
                    />
                  </g>
                  <defs>
                    <filter
                      id="filter0_d_378_1360"
                      x="0"
                      y="0"
                      width="75.3008"
                      height="74.5168"
                    ...
                    >
                      ...
                      <feBlend
                        ...
                        result="effect1_dropShadow_378_1360"
                      />
                      <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_dropShadow_378_1360"
                        result="shape"
                      />
                    </filter>
                  </defs>
